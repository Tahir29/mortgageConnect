...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-25 right-8 z-[9999] lg:hidden w-10 h-10 rounded-full bg-whatsapp
        flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.45)]
    ...
    >
      ...
      <svg
        className="relative z-1 w-5 h-5 text-white"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
