      ...
      <div className="container-site relative z-10 pt-24">
        <div className="animate-fade-in-up">
          <div className="flex items-center gap-2 text-white/40 text-xs mb-6">
            ...
            <span>/</span>
            <span className="text-accent">Our Agents</span>
          </div>
          <div className="gold-rule mb-5" />
          <p className="text-accent text-xs font-semibold tracking-[0.3em] uppercase mb-4">Verified Professionals</p>
          ...
          <p className="mt-4 text-white/55 text-base md:text-lg max-w-xl leading-relaxed">
            Browse verified mortgage consultants across all seven emirates. Filter by specialty, location, language, or company — connect instantly for free.
          </p>
        </div>
      </div>
    </section>
